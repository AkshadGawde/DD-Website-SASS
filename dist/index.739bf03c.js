...
const textLinesReveal = new (0, _textLinesReveal.TextLinesReveal)([
    DOM.textContent.primary,
    DOM.textContent.secondary
]);
// Image reveal obj
const imgReveal = new (0, _imgReveal.ImgReveal)(DOM.img);
// Other text animations
const textReveal = new (0, _textReveal.TextReveal)([
    DOM.textContent.heading,
    DOM.menuCtrl
]);
// Menu
const menu = new (0, _menu.Menu)(DOM.menuWrap);
...
// Preload images
(0, _utils.preloadImages)(".deco__img, .panel__img").then(()=>{
...
},{"./utils":"72Dku","./menu":"dTgwB","./textReveal":"cUOGZ","./textLinesReveal":"2JTlA","./imgReveal":"bpedU","gsap":"fPSuC"}],"72Dku":[function(require,module,exports) {
...
class Menu {
    constructor(el){
        ...
        this.DOM.detailsEl.forEach((detailsEl)=>this.detailsInstances.push(new (0, _details.Details)(detailsEl, this.DOM.closeDetailsCtrl)));
        this.initEvents();
    }
...
},{"./textReveal":"cUOGZ","./details":"4WLcr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cUOGZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4WLcr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Details {
    constructor(el, closeDetailsCtrl){
        ...
        this.textLinesReveal = new (0, _textLinesReveal.TextLinesReveal)(this.DOM.text);
    ...
    open() {
        ...
        this.textReveal.in();
        (0, _gsapDefault.default).killTweensOf(this.DOM.images);
...
},{"./textReveal":"cUOGZ","./textLinesReveal":"2JTlA","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2JTlA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class TextLinesReveal {
    constructor(animationElems){
        this.DOM = {
            animationElems: Array.isArray(animationElems) ? animationElems : [
                animationElems
            ]
        };
        ...
        for (const el of this.DOM.animationElems){
            const SplitTypeInstance = new (0, _splitTypeDefault.default)(el, {
                types: "lines"
            });
            // wrap the lines (div with class .oh)
            // the inner child will be the one animating the transform
            (0, _utils.wrapLines)(SplitTypeInstance.lines, "div", "oh");
    ...
    in() {
        ...
        this.isVisible = true;
        // animation
        (0, _gsap.gsap).killTweensOf(this.lines);
    ...
    initEvents() {
        window.addEventListener("resize", ()=>{
            ...
            // hide the lines
            if (!this.isVisible) (0, _gsap.gsap).set(this.lines, {
                y: "-150%"
            });
        });
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bpedU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
